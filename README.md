...
I am a passionate **Software Engineer** with a focus on full-cycle system development and industrial automation. My recent work at **Percetakan Keselamatan Nasional (PKN)** involved migrating legacy architectures to high-performance internal environments and engineering real-time data-buffering systems for industrial hardware.
...
- **Industrial Protocols:** TCP/IP Sockets, REA-PI XML Protocol.
- **Hardware Integration:** REA JET Printers, Boon Viper Rewinders.
- **System Architecture:** Legacy Migration, Data Buffering Engines, Real-time UID Verification.
...
### 🎓 Education
- **B.IS (Hons.) Information Systems Engineering** | *UiTM Jasin (2022 - 2025)*
- **Diploma in Computer Science** | *UiTM Segamat (2019 - 2022)*
